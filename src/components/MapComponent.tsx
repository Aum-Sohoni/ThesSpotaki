...
export default function MapComponent({ apiKey, isDarkMode, setIsDarkMode }: MapComponentProps) {
  ...
  const ui = language === 'el' ? {
    ...
    findNearbyParking: 'Find parking nearby',
    ...
    confidenceHigh: 'High',
    confidenceDesc: 'Based on traffic and parking trends.',
    suggestedAction: 'Recommended stop',
    ...
    liveCityUpdates: 'Live updates',
    interactiveMap: 'Map',
    mapHint: 'Click the map to set a start point.',
    origin: 'Origin',
    target: 'Target',
